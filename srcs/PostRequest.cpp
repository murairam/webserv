...
/*   Updated: 2025/09/17 23:25:14 by yanli            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "PostRequest.hpp"

void	PostRequest::process(const std::string &s)
{
...
PostRequest::PostRequest(std::string s)
:_target(""), _target_set(false), _query(""), _query_set(false),
_host(""), _host_set(false), _port(0), _port_set(false),
_auth(), _auth_set(false), _cookie(), _cookie_set(false),
_should_reject(false), _persistent(true), _chunked(false),
...
_body(other._body), _body_set(other._body_set)
{}
...
void	PostRequest::setErrCode(void)
{
	if (_err_code_set)
		return ;
	_err_code_set = true;
